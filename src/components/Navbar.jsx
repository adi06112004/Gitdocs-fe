    ...
    <nav className="w-full fixed top-0 z-50 backdrop-blur-md bg-black/60 border-b border-white/10">
      <div className="px-6 py-3 flex items-center justify-between">        
        ...
        <div className="flex items-center space-x-3">
          <button className="text-gray-300 hover:cursor-pointer hover:text-white text-sm font-medium px-3 py-1 transition">
            Sign in
          </button>
          <button className="bg-indigo-600 hover:cursor-pointer hover:bg-indigo-500 text-white text-sm font-semibold px-5 py-2 rounded-lg transition-shadow shadow-indigo-600/20 shadow-md">
            Get Started
          </button>
        </div>
      </div>
